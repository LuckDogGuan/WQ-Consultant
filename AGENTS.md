...
This project is indexed by GitNexus as **wq_gui** (3081 symbols, 8818 relationships, 252 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
