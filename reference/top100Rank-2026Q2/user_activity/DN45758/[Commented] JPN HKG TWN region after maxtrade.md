...
- **链接**: [Commented] JPN HKG TWN region after maxtrade.md
- **作者**: DM28368
- **发布时间/热度**: 1年前, 得票: 11

## 帖子正文

After the WQ update requiring maxtrade installation, it is very difficult to create alpha in the JPN, TWN, HKG regions with very low indexes. The alpha index to be able to submit is low. I want to ask if this is because the market in this region is bad or what? I hope you can answer. ![图片](images/img_e17011e1ea.png)
