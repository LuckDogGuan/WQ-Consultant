...
- **链接**: OS更新后对于这个因子到底能不能交的一点思考 【传奇耐打王系列一】经验分享.md
- **作者**: FX25214
- **发布时间/热度**: 4个月前, 得票: 118
...
点赞“这里提醒了我对于ppa存在的意义。ppa本身的设定就是为了寻找纯粹、简单的信号。这个纯粹二字，其实是相当重要的。因此ppa才没有那么高的提交要求。但这不意味着我们利用这个ppa的规则去混因子。怎么样把小而美的优势充分的在ppa上体现出来，是真正值得我们学习和思考的地方。因此，回到我之前的帖子说的多样性。小的数据集只能做出质量一般的ppa怎么办？别害怕！大胆做！大胆交！把小而美做出来！你怎么知道它不是样本外的superalpha呢？”
...
感谢分享，很有收获。这次更新我有很多IS挺高的alpha，os一落千丈，有一部分是我当时耗时间调参调出来的自以为好的RA。我想起老师经常说的一句话：PPAC不是低质量的代名词。降低了提交标准不意味着看到alpha绿了就submit，为了交而交，是否有合理的经济数学解释，是否为了达标去过拟合，都是要思考慎重的地方。---------------------------------------------------------------------------α≠运气 |α=Edge E [PnL]=∑(E [r_i]×w_i) σ↓→Sharpe↑Factor=Signal-Noise Backtest→Live→Repeat βNeutral|αMaxWin>Loss|Risk<Reward InSample→OutOfSample---------------------------------------------------------------------------

---

### 评论 #4 (作者: FX25214, 时间: 4个月前)

@WT70694小而美本身就从概率上很大程度防止了过拟合。这是其一。其二，大胆交并非无标准的提交。在从一而终的贯彻一个良好标准的前提下尽可能多的提交，就可以在概率的角度实现多样性，降低单因子过拟合的风险。========================量化都可以从概率的角度进行思考============================

---

### 评论 #5 (作者: XX88140, 时间: 3个月前)

谢谢佬分享，交纯粹信号的PPA,可以降低过拟合的风险~~现在对于fitness小于1的因子也没有那么排斥不提交了。==========================DAY DAY UP==========================

---

### 评论 #6 (作者: LK39823, 时间: 3个月前)

牛牛的分享太棒了，你做的这个系列我会一直关注，你的内容直接戳中了像我这种vf比较低的顾问的痛点，不过对于第二个例子，我我观点不太一样，我认为，15到三十的换手率是最稳的，之前看的一个讲量化课的老师的视频也讲过这点，我感觉不一定非的turn小于margin才行，第二个例子的margin确实稍低，我感觉调调还是非常不错的因子===================================================================================α≠运气 |α=Edge E [PnL]=∑(E [r_i]×w_i) σ↓→Sharpe↑Factor=Signal-Noise Backtest→Live→Repeat βNeutral|αMaxWin>Loss|Risk<Reward InSample→OutOfSample=================================================================================

---

### 评论 #7 (作者: MY49971, 时间: 3个月前)

感谢分享，对于不好出的数据集要求确实没必要要求那么多，多样性要求很关键======================================================================================================Talk is cheap,show me the alpha=================================
...
感谢牛牛分享干货，这下对ppa也有了更深层次的审视，不一定指标差的的alpha代表垃圾alpha，主要看是否纯粹和pnl是否漂亮。===============================================================================守正心，戒浮躁，恒复盘，危中机。“复利是世界第八大奇迹，关键在于找到可长期重复的正确策略，日复一日、不疾不徐地执行。”—— 爱因斯坦 / 查理・芒格Alpha∞ Engine Status: ONLINE [♦♦♦♦♦♦♦♦♦♦] 100%sys.setrecursionlimit(α∞)PnL = ∑(Robustness * Creativity)#无限探索、鲁棒性优先，创新性增值# 有志者事竟成，苦心人天不负。千淘万漉虽辛苦，吹尽狂沙始到金。=================================================================================
