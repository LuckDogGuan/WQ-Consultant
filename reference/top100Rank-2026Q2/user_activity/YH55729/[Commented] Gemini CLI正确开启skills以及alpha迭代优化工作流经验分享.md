...
- **链接**: [Commented] Gemini CLI正确开启skills以及alpha迭代优化工作流经验分享.md
- **作者**: HZ32281
- **发布时间/热度**: 4个月前, 得票: 21
...
[YH55729](/hc/en-us/profiles/33590682742039-YH55729)  是的，各种模型都可以尝试看看，哪个好用就用哪个
...
大佬geminicli用不了了谷歌要求转到antigravitycli去，但mcp工具一直用不了不知道什么原因，这里又显示有mcp工具，但是让他工作又一直不调用一直在那里查文件啥的。 ![图片](images/img_4ce8ef8d64.jpeg)  ![图片](images/img_1ad32b25df.jpeg)

---

### 评论 #15 (作者: HZ32281, 时间: 19天前)

[HH34943](/hc/en-us/profiles/37523541660567-HH34943)  你直接把Gemini里面设置了MCP的settings.json给antigravitycli看，让它直接帮你操作就可以了

---

### 评论 #16 (作者: HH34943, 时间: 15天前)
