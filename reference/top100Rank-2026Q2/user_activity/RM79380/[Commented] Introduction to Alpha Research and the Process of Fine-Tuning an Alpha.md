# Introduction to Alpha Research and the Process of Fine-Tuning an Alpha

- **链接**: [Commented] Introduction to Alpha Research and the Process of Fine-Tuning an Alpha.md
- **作者**: IM60066
- **发布时间/热度**: 6个月前, 得票: 11
...
### 评论 #1 (作者: AR43211, 时间: 1个月前)

For sure many at times we tend to fine-tune the alpha  too much leading to overfitting.
