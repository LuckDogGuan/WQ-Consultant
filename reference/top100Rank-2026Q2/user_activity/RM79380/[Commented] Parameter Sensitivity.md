...
- **链接**: [Commented] Parameter Sensitivity.md
- **作者**: BM29781
- **发布时间/热度**: 5个月前, 得票: 15
...
### 评论 #1 (作者: mohamed elmadhoun(ME38078), 时间: 4个月前)

I am working on designing integrated trading models in a Python environment, and I am very careful and test the strategy and signal in all the conditions I mentioned. I put the final mind in an environment to test the breakout, how long it will hold, whether it will collapse quickly, or whether it will survive in all market conditions. However, I am still very weak in understanding how the site works here. Can we work together?
