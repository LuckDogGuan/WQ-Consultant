# Clarification regarding Submission [HELPFUL] for DCC2026

- **链接**: [Commented] Clarification regarding Submission [HELPFUL] for DCC2026.md
- **作者**: TS24319
- **发布时间/热度**: 3个月前, 得票: 7
...
### 评论 #2 (作者: TS24319, 时间: 3个月前)

- **The presentation must be in PDF format, and the notebook must be in .ipynb format.**  *Other forms like supporting .pptx or images (all) can't be uploaded.*
- **First write the description first, then upload as it automatically uploads, and no chance of going back.**
