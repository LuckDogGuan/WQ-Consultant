...
- **链接**: [Commented] Quick question about presentation submission.md
- **作者**: PD54914
- **发布时间/热度**: 2个月前, 得票: 7
...
Since your OS simulations will be computed using the notebooks submitted, make sure the notebooks follow guidelines in these competition FAQs -
 [What are the submission requirements for notebook in DCC](http://what%20are%20the%20submission%20requirements%20for%20notebook%20in%20dcc%20/) 
