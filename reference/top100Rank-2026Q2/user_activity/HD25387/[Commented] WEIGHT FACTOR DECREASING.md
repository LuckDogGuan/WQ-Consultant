# WEIGHT FACTOR DECREASING

- **链接**: [Commented] WEIGHT FACTOR DECREASING.md
- **作者**: SP61833
- **发布时间/热度**: 5个月前, 得票: 5

## 帖子正文

My  **weight factor**  is continuously decreasing. In this quarter, my weight factor has decreased by around 250 points. Is this happening to anyone else?
