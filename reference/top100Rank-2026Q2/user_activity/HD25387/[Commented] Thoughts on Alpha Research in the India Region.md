# Thoughts on Alpha Research in the India Region

- **链接**: [Commented] Thoughts on Alpha Research in the India Region.md
- **作者**: MK58212
- **发布时间/热度**: 5个月前, 得票: 11
...
I usually turn off  **MaxTrade**  because the TOP500 universe is relatively small, so investability is not significantly affected even without strict trading limits. In addition, disabling MaxTrade often helps the alpha pass robustness tests, since the signal behavior becomes less constrained by execution-related filters.
