...
- **链接**: [Commented] 用本地化计算 PnL 相关性来验证 Self Correlation 和 Power Pool Correlation 的关系经验分享.md
- **作者**: LL87164
- **发布时间/热度**: 1年前, 得票: 5
...
![图片](images/img_74ed340c4f.png)

![图片](images/img_857233e021.png)

页面打开同一个Alpha，做相关性检测，数据如下：

![图片](images/img_06d71299c0.png)
...
[SD17531](/hc/zh-cn/profiles/27215746752791-SD17531)
