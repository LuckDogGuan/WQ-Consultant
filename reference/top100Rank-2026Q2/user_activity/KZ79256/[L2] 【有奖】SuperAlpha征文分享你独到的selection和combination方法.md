...
- **链接**: [L2] 【有奖】SuperAlpha征文分享你独到的selection和combination方法.md
- **作者**: WL13229
...
[【SuperAlpha灵感】因子择时模型 – WorldQuant BRAIN]([L2] 【SuperAlpha灵感】因子择时模型Alpha Template.md)   [YW93864](/hc/en-us/profiles/14096946892439-YW93864)
...
[Super-Alpha-自动生成-多线程自动回测-mysql-版本-无惧程序宕机-断点续传]([L2] Super Alpha 自动生成多线程自动回测 mysql 版本 无惧程序宕机断点续传代码优化.md)
