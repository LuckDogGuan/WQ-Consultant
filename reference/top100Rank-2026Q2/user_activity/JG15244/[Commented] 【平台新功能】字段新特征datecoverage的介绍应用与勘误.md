...
哇大佬的速度也太快了，之前回测的时候一直发现有些数据集有大量数据缺失5年以上，特别是earning6等数据集，现在不需要上lab就能确定确实只有四年半的数据，帖子提供的插入即用的get_datafields函数真是太方便了，谢谢大佬，祝GM&VF1！ ![图片](images/img_fccd847196.png)
