...
- **链接**: [Commented] 用Gemini CLI全自动找Alpha工作流纯Template版.md
- **作者**: HZ32281
- **发布时间/热度**: 6个月前, 得票: 86
...
@LU53797下一次出错的时候你就先按Esc停下来，在对话框里质问AI，你说“我已经反复修改了很多次工作流了，究竟要怎样修改工作流提示词你才可以严格遵守？”，然后AI就会给出修改建议，然后你按照AI修改后的提示词来跑就会好很多
