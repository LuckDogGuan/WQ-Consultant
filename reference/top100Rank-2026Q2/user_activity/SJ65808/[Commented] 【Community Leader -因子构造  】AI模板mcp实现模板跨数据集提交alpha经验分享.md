...
- **链接**: [Commented] 【Community Leader -因子构造  】AI模板mcp实现模板跨数据集提交alpha经验分享.md
- **作者**: QX52484
- **发布时间/热度**: 6个月前, 得票: 64
...
![图片](images/img_656ec85121.png)

结合七十二变的拓展思想 让mcp也进行这样的尝试.寻找类似经济学含义的字段或者同数据集字段.

![图片](images/img_a2dad3d1f6.png)

获取的结果

![图片](images/img_eeb9836a0f.png)

![图片](images/img_78ae0e4ec5.png)

这样就实现了从oth515到inst25的拓展.  由于本身alpha模板也比较简单,导致了ppc比较高.

那怎么受得了,进行下一轮优化.

![图片](images/img_bb320e9808.png)

![图片](images/img_a5ef6d8c43.png)

![图片](images/img_df051fdf96.png)

因为操作符总数＞8,无法再按PPA提交了.这里看AI有些陷入局部最优解了,人工介入调整了下参数做到RA.

![图片](images/img_57a4b31567.png)

再进行下一轮

![图片](images/img_775e1a96ad.png)
