...
- **链接**: [Commented] 【经验分享】冲刺 genius 细节决定成-败你的六维还能提升 点塔 alpha模板经验分享.md
- **作者**: ML47973
- **发布时间/热度**: 9个月前, 得票: 125

## 帖子正文

![图片](images/img_cd2a0d58ea.png)

## **一、Genius定级与何相干？**

总体来说，一共与两方面有关，一是  **硬性指标** ，二是  **软指标** 。

![图片](images/img_c764b6b06c.png)
...
![图片](images/img_d0d8fb60c3.png)

**软指标** 又称为“六维数据”，六维六维 很明显就是说有六个维度(指标)。

**![图片](images/img_99f94b92a4.png)**

**![图片](images/img_20baa935d0.png)**
...
![图片](images/img_2802beb091.png)

![图片](images/img_7f0c0c930e.png)

下面的是查询alpha信息的url

![图片](images/img_ef55b0c208.png)

接下来我们就来看看几个alpha，查看它们的数据情况

1 ）alpha表达式：“ - (1 / imb5_score) ”     —>    EUR-TOP2500-D1-OFF  id= '80PXEEz'

![图片](images/img_4bc3d29435.png)

仅仅使用了- 和 / 操作符，我们来查看此alpha的操作符使用情况

![图片](images/img_51de6c7f76.png)
...
![图片](images/img_a5356daed5.png)

我们来看一下操作符的使用，如果操作符信息返回6个，说明操作符重复计算；返回5个说明操作符没有重复计算! 来看结果

![图片](images/img_3e085aedf1.png)
...
当我们在使用 == 和 != 等等 Operators used 时，常常是需要跟判断逻辑if_else、and 和 or 联系的 . 用来提高自己的Operators used，但在提高自己的Operators used时，同时也增加操作符，增大了此 alpha 的 Operators per Alpha，我们应该怎么来权衡这种利弊呢，请期待下一节： [交一个怎样的alpha能提升你的六维数据之定性定量分析 .](../WX64154/[L2] 【分析】Genius冲刺 交一个怎样的alpha能有效提升你的六维数据之定性定量分析.md)
...
![图片](images/img_d3cafc1fc6.png)

![图片](images/img_9bf3b2e75d.png)

![图片](images/img_4c90733896.png)

不建议使用

![图片](images/img_b518b35e19.png)

![图片](images/img_90c8841bd8.png)

![图片](images/img_cf8bbbc20d.png)

**三、alpha模板 ！**

看到这里，你还在想向我找寻alpha模板吗？其实我没有模板 ... 时间多的话可以再瞧一瞧上面的内容，看看能不能给到你一点点启发呢 .

![图片](images/img_9431a3e96e.png)
...
![图片](images/img_467524231d.png)

下节预告:  [Genius冲刺! 交一个怎样的alpha能有效提升你的六维数据之定性定量分析](../WX64154/[L2] 【分析】Genius冲刺 交一个怎样的alpha能有效提升你的六维数据之定性定量分析.md)
...
@ [ML47973](/hc/en-us/profiles/29991129347991-ML47973)  那个Header Basic *****，****部分是由你的email:pwd 编码生成的，是可逆的！建议迅速修改密码，且截图重新打水印。
...
[FX25214](/hc/en-us/profiles/32678330190999-FX25214)
...
我以为 八月也就是帖子上的 combine 会变差，因为七月体提交的 alpha 质量较差，结果 combine 2.39 . 那我理解  combine 增加的原因有  **自身成长 (alpha每日提交数量较前面有增量)** 、 **alpha组群多样性**  和  **prod相关性**  这几个原因，可以从这几个方面去考虑提交 alpha . ![图片](images/img_d8501aa49d.png)
...
min (硬指标, 软指标六维) .   最差可能评为 GOLD级别 .

我曾经也思考过这个问题，就是某Genius季度我硬指标达标可能评级为主人Master，但是六维(不一定差，但是别人更强)拉跨，可能掉下主人而成为专家 Expert，甚至成为小 gold (对于这一点，我觉得自己努力了相信不会太差).  某六维指标评级为大主人 GrandMaster，插件预测全球排名前十，可能会因为硬指标(主要是 alpha 表现) 都有可能评级为 gold 或者 expert .

> Operators used -- 这个计数也包括SA使用到的那些吗？

Operators used 这项指标目前不包括 (bug时期有算入过且无回溯) SA使用到的字段，仅包括 ra (Regular Alpha)、atom (Single Data Set Alpha) 和 ppa (Power Pool Alpha).
...
非常感谢大佬的分享，看完真的学到了很多，现在知道六维的提升方式了
...
真心期待大佬后续能分享更多实操经验，帮我们少走弯路，再次感谢！
...
受益匪浅，学习了，非常好的文章，将六个维度及如何提升讲得非常清楚。
