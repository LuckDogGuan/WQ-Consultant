...
- **链接**: [Commented] 【Community Leader - 因子构造】AI从0到1全自动探索α工作流技巧思路工作流经验分享.md
- **作者**: OB53521
- **发布时间/热度**: 6个月前, 得票: 135
...
如果还没有配置Gemini CLI的顾问，请参考： [【Community Leader - 工具配置】一文讲完用Gemini 3 Pro进行无限Alpha探索（附学生优惠方法/提示词/在服务器中使用）](../MZ45384/[Commented] 【Community Leader - 工具配置】一文讲完用Gemini 3 Pro进行无限Alpha探索附学生优惠方法提示词在服务器中使用经验分享.md)
...
![图片](images/img_b53d6af905.png)

![图片](images/img_238438b29a.png)
...
### 评论 #31 (作者: YB44630, 时间: 4个月前)

感谢大佬这么详细的分享

---

### 评论 #32 (作者: DW99585, 时间: 4个月前)

大佬您好，我在调用MCP中create_multiSim工具总是出现error: No alpha ID found in completed simulation错误，仔细看了代码没找到原因导致ai自动提交一直提交不了，让ai查错误也没解决，是MCP的问题吗？还是我自己操作的问题，已经是最新的cnhkmcp包了

---------------------
@ [CY19763](/hc/en-us/profiles/33604216281367-CY19763)  这个问题 是因为运算符与字段不匹配 或者运算符 不存在导致的

---

### 评论 #33 (作者: JL52079, 时间: 1个月前)

大佬您好，请问下这个工作流通用吗，就是我目前用的是VSCODE里的roocode插件，大模型用的是deepseek，可以直接复用大佬您的工作流吗？望回复，祝大佬常驻GM！

=============================== Just do it！===============================

---

### 评论 #34 (作者: OB53521, 时间: 1个月前)

[JL52079](/hc/en-us/profiles/33979258418071-JL52079)  可能需要微调，可以先自己尝试一下，有事 TG：@konrad253
