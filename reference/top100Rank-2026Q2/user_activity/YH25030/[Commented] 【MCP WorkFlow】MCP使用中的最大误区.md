...
- **链接**: [Commented] 【MCP WorkFlow】MCP使用中的最大误区.md
- **作者**: VC17729
- **发布时间/热度**: 9个月前, 得票: 86
...
### 评论 #10 (作者: QP72475, 时间: 9个月前)

感谢，又学习到了MCP。

---

### 评论 #11 (作者: MS51256, 时间: 9个月前)
...
1、准确率问题：我之前提交过一个帖子（ [基于mcp点亮short Interest](../HP65370/[Commented] 【Alpha灵感】基于MCP提交的3个Short Interest 因子.md) ），很多人问我，deepseek这么强大吗？实际上不是的，关键是提示词，你要说明白要做什么，每一步要非常明确才行，要不然准确率会是负数。
