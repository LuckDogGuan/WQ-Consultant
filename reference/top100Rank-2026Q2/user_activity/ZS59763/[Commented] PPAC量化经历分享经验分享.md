...
- **链接**: [Commented] PPAC量化经历分享经验分享.md
- **作者**: IM49242
- **发布时间/热度**: 1年前, 得票: 2

## 帖子正文

1.得益于ppac比赛，alpha的提交不再需要Production correlation的检测。三阶模板可以在usa delay1中回测获取大量alpha。在一个数据集中太多的回测结果在提交3个alpha左右后过多的alpha的自相关性不再满足比赛的条件。巧合下，我在平台上看到了KZ79256分享的本地0误差计算自相关性的帖子，阅读完帖子就可以轻松使用。再通过剪枝函数可以减少check的数量，更快找到可以提交的alpha。
