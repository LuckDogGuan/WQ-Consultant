...
The  [Z-Score](../DN45758/[Commented] Understanding Z-Score OperatorsResearch.md) , a powerful statistical measure for standardizing data, extends to time-series data as ts_zscore.
...
Hi TT55495! There is a post about calculating returns (please refer to the first comment under this post it is more readable -  **[4 Ways to Calculate Returns](../DN45758/[Commented] 4 ways for you to calculate returnsResearch.md)** )
