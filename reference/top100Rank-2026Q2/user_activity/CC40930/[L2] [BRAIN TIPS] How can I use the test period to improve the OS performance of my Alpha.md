...
- **链接**: [L2] [BRAIN TIPS] How can I use the test period to improve the OS performance of my Alpha.md
- **作者**: NL41370
...
4. The stats for test period are hidden by default. Compare the stats for test period with training period by clicking the “Show test period button” on top of the Simulation results. ![图片](images/img_412e827e7c.png)
