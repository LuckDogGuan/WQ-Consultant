...
- **链接**: [L2] Understanding ts_zscoreResearch.md
- **作者**: AG20578
- **发布时间/热度**: 1年前, 得票: 10

## 帖子正文

The  [Z-Score](/hc/en-us/community/posts/24912183913495-Understanding-Z-Score-Operators) , a powerful statistical measure for standardizing data, extends to time-series data as ts_zscore.
...
Hi TT55495! There is a post about calculating returns (please refer to the first comment under this post it is more readable -  **[4 Ways to Calculate Returns](/hc/en-us/community/posts/23977710448663-4-ways-for-you-to-calculate-returns)** )
