# On AI and Automation in Quant Research

- **链接**: [Commented] On AI and Automation in Quant Research.md
- **作者**: UN28170
- **发布时间/热度**: 8个月前, 得票: 7
...
### 评论 #2 (作者: AK58642, 时间: 8个月前)

human with AI will replace people  human without AI

---

### 评论 #3 (作者: KG79468, 时间: 8个月前)

I see AI as an amplifier of human research, not a replacement. It helps identify subtle interactions faster, but domain knowledge and intuition remain essential to judge whether a pattern is real or just data noise.

---

### 评论 #4 (作者: AG14039, 时间: 6个月前)

I view AI as a powerful enhancer of human research rather than a substitute for it. It can surface subtle relationships much more quickly, but domain expertise and intuition are still crucial for determining whether those patterns reflect genuine market behavior or are simply noise in the data.
