...
- **链接**: Increase fitness.md
- **作者**: KU30147
- **发布时间/热度**: 6个月前, 得票: 14

## 帖子正文

After submitting some alphas now i am finding very hard to make good performing alphas . Earlier i was able to make them in 3-4 hours but now i am not able to do it.either correlation is high or the alpha is not worth submitting .Can anyone suggest me how I can tackle this problem.Thank you for your valuable insights in advance.
...
This usually happens after you’ve exhausted the “low-hanging fruit.” At that stage, fitness doesn’t improve by faster iteration but bychanging the search space. Switch data categories or regions, start from an economic intuition first (not operators), and test fewer but deeper ideas. Also, high correlation is often a signal you’re recycling exposure — not that you’ve lost skill.
