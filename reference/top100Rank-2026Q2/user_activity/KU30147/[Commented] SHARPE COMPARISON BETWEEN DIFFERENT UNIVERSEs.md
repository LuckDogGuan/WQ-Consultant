# SHARPE COMPARISON BETWEEN DIFFERENT UNIVERSE(s)

- **链接**: [Commented] SHARPE COMPARISON BETWEEN DIFFERENT UNIVERSEs.md
- **作者**: DN28451
- **发布时间/热度**: 5个月前, 得票: 4
...
### 评论 #1 (作者: RO79347, 时间: 5个月前)

SUBMIT ALPHA 1, LOWER TURNOVER, LOWER DRAWDOWN AND HIGHER MARGIN. THANK ME LATER!
...
Both are strong, but I’d lean toward  **Alpha 1 (TOP2500)** . Similar Sharpe with much lower turnover and drawdown usually means better scalability and robustness.
