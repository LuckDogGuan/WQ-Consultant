...
![图片](images/img_e33d0e2faa.png)

我用的推送格式如图:

![图片](images/img_845c830836.png)

![图片](images/img_8d688db62e.png)

现在回测数不重要所以被我挪到最后了. 感谢 [SZ83096](/hc/en-us/profiles/29001331587351-SZ83096)  橘子姐姐的画图代码. 抄了放在我代码库里很久了, 一直懒的运行, 终于找到它的用途了.
...
[Vscode自动提示operator](../JR23144/[Commented] Vscode自动提示operator代码优化.md)

[【Community Leader -因子筛选与组合⭐】本地数据库的使用(筛选)](../LW67640/[L2] 【Community Leader -因子筛选与组合】本地数据库的使用筛选代码优化.md)
