...
- **链接**: [Commented] 0帧起手的字段构建【传奇耐打王系列三】经验分享.md
- **作者**: FX25214
- **发布时间/热度**: 29天前, 得票: 25
...
我认为大佬的思想是比较新颖的，在字段构建这个方面给了我很大的启发。

在如今AI文章充斥整个论坛的时代，大佬还能保持自己的一点思考，实在是难得的。

不是说AI就一定不好，只是有相当一部分顾问比较急功近利（可能？），太迫切想要拿别人的代码、提示词实现VF、CB的飞跃了。然而别人的东西终究不是自己的，不清楚原理则永远无法通向成功。我觉得还是应该从因子构建的根本原则出发，把文章的内容复现一遍，而不是把文章直接喂给AI，让AI代替人类的思考，甚至拿AI把文章洗一遍然后发一篇新的。

以上是我阅读本文，结合当今论坛文章的总体情况，得出的一点启示，希望对大家有所帮助。

---

### 评论 #4 (作者: FF65210, 时间: 28天前)

太强了牛牛，不愧是数学专业的，对公示的敏感性和研究思考深度比我强太多，希望能在量化的路上越走越远，祝佬早日拿到WQ的实习。
...
大佬的系列文章看下来非常有启发，直击痛点 👍

感觉比较有理论基础，而不是一味压field per alpha<2的搞法
