...
- **链接**: [Commented] 我的量化之路 我是如何用上AI做量化的经验分享.md
- **作者**: SZ84537
- **发布时间/热度**: 5个月前, 得票: 7
...
![图片](images/img_f6ffd118be.png)

还是有信号的，告诉deepsee可实现的收益曲线低，让改进，在验证了一堆方案后，发现行业中性化有效。

![图片](images/img_fb4c7a6e00.png)
