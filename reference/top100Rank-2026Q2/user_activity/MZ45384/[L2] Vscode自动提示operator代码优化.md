...
- **链接**: [L2] Vscode自动提示operator代码优化.md
- **作者**: WL27618
- **发布时间/热度**: 1年前, 得票: 72
...
有时候一边写代码一边查opeartor网页会非常打断思路, 我们可以基于自己的 JSON 文档开发一个轻量级的 VSCode 插件，提供 **悬停文档** 和 **自动补全** 功能，用于自定义的 **数据字段** 和 **运算符** ，。
 ...
 ![图片](images/img_8fd3d5ab94.png) 

大家可以在vscode搜我编译好的插件试一下.

 ![图片](images/img_fbd47d9a33.png) 
加载自己的opeartors. 像这样, 在这里添加自己的json路径.

 ![图片](images/img_19c5c57150.png)
...
### 评论 #4 (作者: WL27618, 时间: 1年前)

![图片](images/img_2c4124ffd7.png) 
 ![图片](images/img_11aa512952.png) 我又添加了universe和neutralization的提示. 
...
### 评论 #8 (作者: WL27618, 时间: 8个月前)

![图片](images/img_c653cf0414.png)

![图片](images/img_07185bfbc0.png) 添加sa fields的提示. 
