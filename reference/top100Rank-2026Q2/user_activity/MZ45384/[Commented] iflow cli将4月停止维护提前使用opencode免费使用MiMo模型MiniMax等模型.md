...
- **链接**: [Commented] iflow cli将4月停止维护提前使用opencode免费使用MiMo模型MiniMax等模型.md
- **作者**: AX58883
- **发布时间/热度**: 3个月前, 得票: 11
...
![图片](images/img_eca1ee7320.png)

这里我修改的是全局路径的opencode.jsonc，当然你也可以修改当前目录下的json文件。

![图片](images/img_c1f9079ac3.png)
...
![图片](images/img_a3764fc5f5.png)

**4 选择免费模型**

在对话框下面就可以选择模型了

![图片](images/img_e3014a5115.png)
