...
- **链接**: [Commented] 因子复现日记操作符复现1【传奇耐打王系列二】.md
- **作者**: FX25214
- **发布时间/热度**: 7个月前, 得票: 13
...
![图片](images/img_0655f9975d.png)

我们看到，这是一个简单的时间序列上的均值与标准差的比值。这不就是我们熟悉的IR——信息比率吗？

我查看该字段的描述：

![图片](images/img_6400998e54.png)
...
![图片](images/img_424cc7b6be.png)

![图片](images/img_ec26da1832.png)
