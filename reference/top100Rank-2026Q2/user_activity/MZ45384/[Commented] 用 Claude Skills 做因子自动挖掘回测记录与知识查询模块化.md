...
iflow 在 \.iflow\skills 增加 这个skills文件夹 然后把 skill全部拷贝进去  ![图片](images/img_e5308c1828.png)  ![图片](images/img_b979dc872b.png)  ![图片](images/img_ab48872b85.png) 我使用的是工作流.md 里面增加了 skills 目前用起来感觉不错 感谢大佬分享

![图片](images/img_505b20d693.png)
