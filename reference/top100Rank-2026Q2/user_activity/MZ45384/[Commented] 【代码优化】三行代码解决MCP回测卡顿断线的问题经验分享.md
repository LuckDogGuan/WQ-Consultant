...
（1）新增启动参数host和port，如图所示。 ![图片](images/img_a80cf19abe.png)

（2）修改文件最后一行，如图所示。

![图片](images/img_98f107653a.png)

2、打开cmd命令行或者power shell，进入platform_functions.py所在目录，然后运行

> python platform_functions.py

![图片](images/img_d9f70878c7.png)
...
![图片](images/img_504075bf13.png)

**成功界面展示：**

![图片](images/img_6bc5b41ef3.png)
