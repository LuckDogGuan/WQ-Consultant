...
- **链接**: [Commented] 【PPAC】比赛中的相关性如何影响Base payment.md
- **作者**: AK76468
- **发布时间/热度**: 1年前, 得票: 60
...
相信很多顾问都发现了： **Self&Proc Correlation为零的alpha，它们的base payment很高** 在maxTrade theme开始的时候，我抱着测试的心态提交了 ***Alpha1*** ：
 ![图片](images/img_27d327d577.png)  ![图片](images/img_25218eb6d8.png)

这个base payment给到了6.07$（新人顾问，vf=0.5）

对于这一个 ***Alpha2*** ：

![图片](images/img_15532fd462.png)

在slow中性化设置下的表现应该还算不错，但是在theme加成下的base是1.56$

再看这个 ***Alpha3：***

***![图片](images/img_769ca6db59.png)  ![图片](images/img_71f8055940.png)*** 这个表现比 ***Alpha2*** 差很多，但是在theme加成下给了3.88$
